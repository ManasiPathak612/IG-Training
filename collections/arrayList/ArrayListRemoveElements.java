...
public class ArrayListRemoveElements {
	 public static void main(String[] args) {
	        ...
	        System.out.println("New list for scripting languages: " + scriptingLanguages);

	        programmingLanguages.removeAll(scriptingLanguages);
	        System.out.println("After removing scriptingLanguages from programming languages: " + programmingLanguages );
